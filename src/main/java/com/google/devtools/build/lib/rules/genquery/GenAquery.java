...
public final class GenAquery
  ...
  public ConfiguredTarget create(RuleContext ruleContext)
    ...
    try {
      ...
      if (!parser.getOptions(AqueryOptions.class).includePrunedInputs) {
  ...
  public GenQueryResult evaluate(
    ...
    options.includeCommandline = options.includeCommandline || options.includeParamFiles;
    ...
    try (ScopedEnvironment query =
            ...
            ImmutableList.sortedCopyOf(
                Comparator.comparing(
                    ...
                    .thenComparing(
                        ...
                        GenAnalysisQuery.CONFIGURED_TARGET_ORDER),
                selected);
      }
      ...
      for (ConfiguredTargetValue value : targets) {
        ...
        if (options.useAspects) {
          ...
          aspects.sort(GenAnalysisQuery.ASPECT_ORDER);
      ...
      if (!options.outputFormat.equals("commands") && !options.outputFormat.equals("summary")) {
      ...
      try (GenQueryOutputStream out = new GenQueryOutputStream(request.compressedOutput())) {
        if (textOutput) {
          ...
          try (GenAqueryOutputHandler handler =
              new GenAqueryOutputHandler(OutputType.fromString(options.outputFormat), out)) {
