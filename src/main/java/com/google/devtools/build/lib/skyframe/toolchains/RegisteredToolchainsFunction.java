...
public class RegisteredToolchainsFunction implements SkyFunction {
  ...
  @Nullable
  static ImmutableSet<Label> filterToolchainTypes(
  ...
  @Nullable
  static ImmutableSet<Label> filterTargetPlatforms(
      Environment env,
  ...
  public SkyValue compute(SkyKey skyKey, Environment env)
    ...
    // is shared by configurations with the same registration, filtering, and analysis flags.
